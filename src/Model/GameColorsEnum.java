...
private GameColorsEnum(String name, Color dieColor, Color dieColorblindColor, Color patternColor, Color patternColorblindColor) {
		this.name = name;
	...
	public static Color getColorFromName(String name, boolean colorblind, boolean isDieColor) {
		for (GameColorsEnum gameColor : GameColorsEnum.values()) {
